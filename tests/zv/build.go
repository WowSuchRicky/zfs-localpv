/*
Copyright 2019-2025 The OpenEBS Authors
...
func NewBuilder() *Builder {
	return &Builder{zv: &ZV{object: &apis.ZFSVolume{}}}
}

// // BuildFrom returns new instance of Builder
// // from the provided api instance
// func BuildFrom(p *corev1.PersistentVolumeClaim) *Builder {
// 	if pvc == nil {
// 		b := NewBuilder()
// 		b.errs = append(
// 			b.errs,
...
// WithNamespace sets the Namespace field of ZV provided arguments
func (b *Builder) WithNamespace(namespace string) *Builder {
	if len(namespace) == 0 {
		namespace = "default"
	}
	b.zv.object.Namespace = namespace
	return b
}
